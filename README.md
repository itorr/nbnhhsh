...
## 安装脚本
安装好油猴脚本浏览器插件之后，访问 [nbnhhsh.user.js](https://github.com/itorr/nbnhhsh/raw/master/nbnhhsh.user.js) 完成脚本安装
...
安装过程可参考 <a href="https://greasyfork.org/zh-CN/">https://greasyfork.org/zh-CN/</a> 首页的，<b>第一步：安装一个用户脚本管理器</b> 章节
